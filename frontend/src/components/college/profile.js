      ...
      onSubmit = async (e) => {
        ...
        try {
          const res = await axios.put(
            `http://localhost:3000/api/v1/colleges/${this.state.profile._id}/photo`,
            data,
            config
          );
        //   this.setState({
        ...
        return (
            ...
            <form method="post">
                <div class="row">
                    ...
                    <div class="col-md-2">
                       <Link to="/college/editprof"> <input type="submit" class="profile-edit-btn" name="btnAddMore" value="Edit Profile"/></Link>
                    </div>
                </div>
                <div class="row">
                    {/* <div class="col-md-4">
