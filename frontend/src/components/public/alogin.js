...
class alogin extends Component {
    ...
    render() {
        ...
        return (
            <Fragment>{this.state.isAuth?(<Redirect isAuth={this.state.isAuth} to="/admin/home"/>):(
           <div>
               ...
               <form method="post" onSubmit={this.onSubmit}>
                  <div className="container "><br/><br/>
                      <div className="card card-header mx-auto col-md-5"> 
                          ...
                          <button type="submit"  name="submit" value="Login"  className="btn col-md-8 mx-auto btn-success">Login</button><br/>
